...
// Die Blockschicht (reportExportBloecke, buildReportCsv) steht seit v5.14 in
// test/report-export.test.js.
...
const { parseReportCsv, autoOutletGroup, autoBrandGroup, buildReportModel,
  formatAmountCH, formatIntCH, mergeReportConfig, autorisiertDifferenz } = app;
